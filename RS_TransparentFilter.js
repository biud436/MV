...
(function ($) {
  ...
  $.loadTransparentKey = function () {
    ...
    xhr.onload = function () {
      if (xhr.status < 400) {
        RS.TransparentFilter.Params.TransparentKey = $.jsonParse(
          xhr.responseText
        );
      }
    };
  ...
  PIXI.filters.TransparentFilter.prototype = Object.create(
    PIXI.Filter.prototype
  );
  PIXI.filters.TransparentFilter.prototype.constructor =
    PIXI.filters.TransparentFilter;
  ...
  var alias_Sprite_Character_updateBitmap =
