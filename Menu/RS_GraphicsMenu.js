...
(() => {
    ...
    class Scene_GraphicsMenu extends Scene_MenuBase {
        ...
        right() {
            ...
            Scene_GraphicsMenu.INDEX = (Scene_GraphicsMenu.INDEX + 1).mod(RECT.length);
        ...
        updateIndex() {
            ...
            this.setRect(this._rect[Scene_GraphicsMenu.INDEX], Scene_GraphicsMenu.INDEX);
        ...
        loadBitmap(x, y, w, h, index) {
            ...
            const sprite = new Sprite(ImageManager.loadPicture(parameters['Menu Image']));
