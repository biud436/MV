 ...
 */
 /*:ko
 * RS_YoutubePlayer.js
 * @plugindesc 유투브 동영상 재생을 할 수 있는 플러그인입니다.
 * @author 러닝은빛(biud436)
 * @help
 * 유투브 동영상 재생을 할 수 있는 플러그인입니다. 동영상은 화면 바깥을 누르거나
 * 끝까지 보게 될 경우 자동으로 종료됩니다.
 * 소유자가 유투브 이외의 다른 사이트에서 재생을 막아놓은 경우라면 동영상 바깥을 클릭하여
 * 동영상을 종료하시기 바랍니다.
 * 참고로 동영상을 보는 동안 플레이어의 이동은 중지됩니다.
 * =============================================================================
 * 플러그인 커맨드
 * =============================================================================
 * - 이 명령어는 유투브 동영상의 재생을 시작할 수 있는 명령어입니다.
 * 아래와 같이 주소를 기입하세요. 인터넷이 연결되어있지 않으면 오류가 날 수 있습니다.
 *
 * YTPlayer play https://www.youtube.com/watch?v=C4ze-KCSxQY
 *
 * - 아래 명령어는 현재 재생중인 동영상의 재생을 중지하고, 게임 화면으로 되돌아가는 명령어입니다.
 *
 * YTPlayer stop
 *
 * =============================================================================
 ...
 * =============================================================================
 * 2016.05.08 (v1.0.0) - First Release
 * 2016.05.09 (v1.0.1) - 에러 핸들링 함수 추가
 * 2016.05.12 (v1.0.2) - URL 파싱 부분 수정
 * 2016.07.04 (v1.0.3) - 범위 체크 코드를 사각형 객체로 변경했습니다.
 */
