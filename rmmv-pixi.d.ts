...
declare class WindowLayer extends PIXI.Container {
   ...
   * @private
   */
  protected _canvasClearWindowRect(
    renderSession: PIXI.CanvasRenderer,
    window: Window
  ): void;
...
declare namespace PIXI {
  ...
  class Filter {
    constructor(
      vertexSrc?: string,
      fragmentSrc?: string,
      uniforms?: { [name: string]: UniformData }
    );
