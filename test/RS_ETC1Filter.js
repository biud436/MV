...
(function () {
  ...
  if (
    ...
    console.warn(
      'This plugin needs to be used for RPG Maker MV v1.3.5 or higher.'
    );
    return;
  }
  ...
  if (!Graphics.isWebGL()) {
    console.warn(
      'This plugin needs to be used a WebGL. Cannot supported in the canvas mode.'
    );
    return;
  }
  ...
  PIXI.ETC1Filter.prototype.apply = function (
    filterManager,
    input,
    output,
    clear
