...
(function () {
  ...
  RS.HUD.param.szTpOutlineColor = String(
  ...
  RS.HUD.initBattleParameters = function () {
    ...
    for (var i = 0; i < RS.HUD.param.nBttleMememberSize; i++) {
      ...
      RS.HUD.param.ptCustormBattleAnchor[i] = RS.HUD.loadCustomBattlePosition(
  ...
  HUD.prototype.createAllIcon = function () {
    this._Iconlayer = new Sprite(
      new Bitmap(Graphics.boxWidth, Graphics.boxHeight)
    );
  ...
  HUD.prototype.getAnchor = function (magnet) {
    ...
    if (this.inBattle()) {
      ...
      anchor['LeftTop'].y =
        Graphics.boxHeight - RS.HUD.param.nHeight * 2 - RS.HUD.param.nPD;
      anchor['RightBottom'].x -= Graphics.boxWidth / 8;
      anchor['LeftBottom'].y =
        Graphics.boxHeight - RS.HUD.param.nHeight - RS.HUD.param.nPD;
      anchor['RightTop'].y =
        Graphics.boxHeight - RS.HUD.param.nHeight * 2 - RS.HUD.param.nPD;
  ...
  var alias_Scene_Battle_createStatusWindow =
  ...
  Bitmap.prototype.rsDrawArc = function (
    x,
    y,
    r,
    startingAngle,
