...
(function ($) {
  ...
  Window_Base.prototype.builder = function () {
    ...
    this._builderState.lifeTime =
      parseInt(arguments[3]) || parseInt(parameters['Life Time']) || 10000;
  ...
  Window_Base.prototype.updateAutoTerminate = function () {
    ...
    if (
      performance.now() - this._builderState.initTimer >=
      this._builderState.lifeTime
    ) {
      if (this.parent) {
