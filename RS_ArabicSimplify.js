...
(function($) {
    ...
    $.Params.arabicFont = String(parameters["Arabic Font"] || "Simplified Arabic, Times New Roman, Segoe UI");
    ...
    Window_Base.prototype.standardFontFace = function() {
        if ($.Params.messageMode === "arabic" || navigator.language.match(/^ar/)) {
    ...
    var alias_Window_Base_processNormalCharacter = Window_Base.prototype.processNormalCharacter;
    Window_Base.prototype.processNormalCharacter = function(textState) {
        ...
        var allLines = textState.text.slice(textState.index++).split(/[\r\n]+/);
        var currentLine = allLines[0] || "";
        var currentText = "";
